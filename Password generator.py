...
Label(root, font=('bold', 8), text='Generate Password').pack()
...
def passwordGeneration(n):
    ...
    l = Label(root, text=password, font=('bold', 15)) 
    l.place(x=225, y=65)
...
Button(root, text='Generate Password', font=('bold', 10),bg='green', command=getLength).place(x=230, y=100)
